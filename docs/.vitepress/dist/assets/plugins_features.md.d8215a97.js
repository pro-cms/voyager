import{_ as n,c as s,o as a,a as t}from"./app.90841b51.js";const f='{"title":"Features","description":"","frontmatter":{},"headers":[],"relativePath":"plugins/features.md"}',e={},o=t(`<h1 id="features" tabindex="-1">Features <a class="header-anchor" href="#features" aria-hidden="true">#</a></h1><div class="language-php"><pre><code><span class="token keyword">namespace</span> <span class="token package">My<span class="token punctuation">\\</span>Formfield</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre></div>`,2),p=[o];function c(l,i,u,k,r,d){return a(),s("div",null,p)}var y=n(e,[["render",c]]);export{f as __pageData,y as default};
